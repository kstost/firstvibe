...
### 고려할 범위
- 개요, 목표, 사용자 스토리, 요구사항 등 모든 필수 PRD 섹션을 포함하세요.
- 각 요구사항과 기능에 대한 명확한 근거를 제공하세요.
- 기능적 요구사항과 비기능적 요구사항을 모두 포함하세요.
- 사용자 경험, 비즈니스 영향을 다루세요.
- 기술적 고려사항에 대해서는 논하지 마세요.
...
## 기술 스택의 선택
- 웹사이트 작업의 경우는 Next.js 기반으로 해서 Firebase나 Supabase를 활용하는 방향으로 선택.
  - Firebase, Supabase와의 통신은 반드시 Next.js Backend측에서 이루어져야한다.
- 앱을 만든다고한다면 웹사이트 작업을 위한 스택과 동일한 방법을 선택하거나 Flutter를 선택.
- 웹사이트나 앱 이 외의 개발을 하는경우에는 그에 맞는 스택 선정.
- 사용자가 요구하는 스택이 있다면 그것을 우선으로 한다.
